...
1. **<font color="#d83931">속성(attribute)</font>**<br>
	\: <font color="#d83931">각 열에 부여된 이름</font>이며, 학번, 이름, 학과명, 성별, 성적이 속성에 해당.
2. **<font color="#d83931">도메인(domain)</font>**<br>
	\: <font color="#d83931">각 속성에 입력 가능한 값들의 범위</font>를 말한다. 성별 속성의 도메인은 '남' 또는 '여'가 된다.
3. **<font color="#d83931">차수(degree)</font>**<br>
	\: <font color="#d83931">속성의 수</font>를 말하며, 위의 예에서는 5개의 속성이 있으므로 차수는 5가 된다.
4. **<font color="#d83931">튜플(tuple)</font>**<br>
	\: <font color="#d83931">각 행을 '튜플'</font>이라 하는데,  <font color="#d83931">하나의 튜플은 각 속성에서 정의된 값 들을 이용해서 구성</font>된다. 위의 예에서는 <21626001, 홍길동, 스마트IT학과, 남, 95>가 하나의 튜플이 된다.
5. **<font color="#d83931">카디널리티(cardinality)</font>**<br>
	\: <font color="#d83931">튜플의 수를 '카디널리티'</font>라 하고, 3개의 튜플이 있으므로 카디널리티는 3이 된다.
6. **<font color="#d83931">릴레이션(relation)</font>**<br>
	\: <font color="#d83931">테이블을 '릴레이션'</font>이라 하는데, <font color="#d83931">중복된 튜플이 있어서는 안되고, 중복된 속성이 있어서도 안된다.</font>
...
## 2.2.1 속성의 정의
- **단순 속성**<br>
	\: <font color="#d83931">속성 값이 하나의 의미만을 가지는 것.</font>
- **복합 속성**<br>
	\: <font color="#d83931">속성 값이 여러 의미를 포함</font>하는 것.
- **단일 값 속성**<br>
	\: <font color="#d83931">원자 값인 것으로 하나의 값만 존재</font>하는 것
- **다중 값 속성**<br>
	\: <font color="#d83931">속성 값이 여러 개 존재</font>할 수 있는 것.
- **널 속성**<br>
	\: <font color="#d83931">속성 값이 널 값(null value)</font>인 것.
- **유도 속성**<br>
	\: <font color="#d83931">새롭게 유도해 낸 속성</font><br>
...
## 2.2.6 도메인(domain)
- <font color="#d83931">**도메인(domain)**은 특정 속성이 가질 수 있는 원자 값들의 집합</font>을 가리킨다.
	<img src="/images/2024-04-17-DatabaseSystem-Chapter3/Picture12.png" width="800"><br>

## 2.2.7 키(key)
- <font color="#d83931">**키(key)**는 릴레이션의 튜플을 유일하게 식별할 수 있는 속성의 집합.</font>
- **유일성(Uniqueness)**<br>
	\: <font color="#d83931">속성의 집합인 키의 내용이 릴레이션 내에서 유일하다는 특성.</font>
- **최소성(Minimality)**<br>
	\: <font color="#d83931">속성의 집합인 키가 릴레이션의 모든 튜플을 유일하게 식별하기 위하여 꼭 필요한 속성들로 구성되는 것.</font>
...
2. <font color="#d83931">테이블은 릴레이션, 릴레이션의 열은 속성(attribute), 행을 튜플(tuple)</font>이라 함.
3. <font color="#d83931">하나의 릴레이션이 갖는 속성 수를 차수(degree), 튜플 수를 카디널리티(cardinality)</font>라고 함.
4. <font color="#d83931">릴레이션은 고유 이름을 가지며, 릴레이션 내에서 속성명은 유일해야 함</font>
5. 릴레이션의 특성
	- <font color="#d83931">모든 속성 값은 원자 값(atomic value)으로 구성</font>된다.
	- <font color="#d83931">릴레이션을 구성하는 속성들 간에는 순서가 없다.</font>
	- <font color="#d83931">릴레이션에 저장된 튜플 간에는 순서가 없다.</font>
	- <font color="#d83931">튜플은 유일하다(중복된 튜플이 존재하지 않음).</font>

## 2.4 관계 데이터 모델의 키 분류
- **수퍼키**<br>
	\: 유일성은 특성을 만족하는 속성 또는 속성들의 집합, 최소성은 만족시키지 못함.
- **후보키**<br>
	\: 유일성과 최소성을 만족하는 속성 또는 속성들의 집합.
- **기본키**<br>
	\: 후보키들 중 하나를 선정해 사용하는 것.
- **대체키**<br>
	\: 후보키를 대체할 수 있는 키(키본키로 선택되지 못한 후보키).
- **외래키**<br>
	\: 한 릴레이션(R1)에 속한 속성 또는 속성의 집합이 다른 릴레이션(R2)에서 기본 키로 이용되는 것(다른 릴레이션의 기본키를 그대로 참조).
...
# 3. 관계 데이터 제약
- **<font color="#d83931">도메인 무결성 제약</font>**
	- **도메인**: 특정 속성(attribute)이 가질 수 있는 원자 값들의 집합.
	- 속성 값이 허용될 수 있는가를 규정하는 것으로, 삽입 및 갱신 연산에 적용.
- **<font color="#d83931">개체 무결성 제약(기본 키 제약 조건)</font>**
	- 릴레이션의 기본 키 속성은 널 값을 가질 수 없는 것.
- **<font color="#d83931">참조 무결성 제약</font>**
	- 외래키는 참조할 수 없는 값을 가질 수 없는 것.
	- 즉, 릴레이션 R1에 저장된 튜플이 릴레이션 R2에 있는 튜플을 참조하려면 참조되는 튜플이 반드시 R2에 존재해야 한다는 데이터 무결성.
